...
public class RecordAdapter extends BaseAdapter{
    ...
    public RecordAdapter(Context context, List<HashMap<String, String>> data) {
    ...
    public View getView(int index, View paramView, ViewGroup paramViewGroup) {
        ...
        if (paramView == null) {// view为null则创建，优化性能
            ...
            paramView = LayoutInflater.from(mContext).inflate(R.layout.item_record ,null);
            ...
            holder.cz = (TextView) paramView.findViewById(R.id.item_cz);
        ...
        holder.cz.setText(data.get("cz") == null ? "" : data.get("cz"));
